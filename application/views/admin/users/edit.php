<div class="container">
    ...
    <form action="<?php echo URL . "admin/update_user" ?>" method="post" class="form-control p-3">
        <input type="hidden" id="email" name="email" value="<?php echo $user->get_email(); ?>">
        <label for="email" class="form-label">Nome</label>
        <input type="text" class="form-control" id="name" name="name" value="<?php echo $user->get_name(); ?>" required>
        <br>
        <label for="email" class="form-label">Cognome</label>
        <input type="text" class="form-control" id="surname" name="surname" value="<?php echo $user->get_surname(); ?>" required>
        <br>
        <label for="email" class="form-label">E-Mail</label>
        <input type="email" class="form-control" id="email" name="email" value="<?php echo $user->get_email(); ?>" disabled>
        <br>
